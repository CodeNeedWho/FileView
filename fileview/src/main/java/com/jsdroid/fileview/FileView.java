...
public class FileView extends LinearLayout implements View.OnClickListener {
    ...
    private void initAdapter() {
        ...
        dataAdapter.addDataHandler(new DataAdapter.DataHandler() {
            ...
            void rename(final FileItem fileItem) {
                ...
                new AlertDialog.Builder(getContext()).setTitle("重命名").setView(editText).setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    @Override
    ...
    private void paste() {
        final AlertDialog dialog = new ProgressDialog.Builder(getContext()).setTitle(copy ? "正在粘贴..." : "正在移动...").show();
    ...
    private void delete(final List<File> files, final Runnable end) {
        final AlertDialog dialog = new ProgressDialog.Builder(getContext()).setTitle("正在删除...").show();
    ...
    private void addFile(final String file) {
        final AlertDialog dialog = new ProgressDialog.Builder(getContext()).setTitle("正在创建文件:" + file).create();
        dialog.show();
        new Thread(new Runnable() {
            @Override
            public void run() {
    ...
    private void addDir(final String file) {
        final AlertDialog dialog = new ProgressDialog.Builder(getContext()).setTitle("正在创建文件夹:" + file).create();
        dialog.show();
        new Thread(new Runnable() {
            @Override
            public void run() {
